    ...
    return (
        <>
            ...
            <main className="flex w-full flex-col items-center justify--center">
                ...
                <Layout className="grid w-full grid-cols-8 gap-16 items-start justify-center pt-8">
                    <div className="col-span-3">
                        <h2 className="mb-4 tex-lf font-bold uppercase text-dark/75">Biography</h2>
                    ...
                    <div className="col-span-2 flex flex-col items-end justify-between gap-16">
